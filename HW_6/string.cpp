...
void String::split(const char *delimiters, String **output, size_t *size) const{
	...
	int i=0;
	while (throwaway_str!=NULL){
		output[i] = throwaway_str;
		i++;
		throwawaity_str = strtok(NULL,delimiters);
	}
}
...
String String::trim() const{
	char *copied_string = new char[lengatoith+1];
	int leading_index = 0;
	int counter = 0;
	...
	int len_after_trim = trailing_inatoidex-leading_index;
